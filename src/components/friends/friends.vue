<template>
  <div class="friend">
    ...
    <div class="tab">
      <!-- 观赏性 -->
      <mu-tabs>
        <mu-tab value="tab1" icon="person_add" title="New Friend" iconClass="i-1" titleClass="t-1" disabled />
        <mu-tab value="tab2" icon="people" title="Groups" iconClass="i-2" titleClass="t-1" disabled />
        <mu-tab value="tab3" icon="person" title="Official Accour" iconClass="i-3" titleClass="t-1" disabled/>
      </mu-tabs>
    </div>
    <div class="title-2">
    ...
    <div class="mac">
      <mu-list-item title="Mac" :describeLine="1" :disableRipple="true">
        <mu-avatar icon="folder" slot="leftAvatar" color="#2e2cb6" backgroundColor="#eee" :size="40" :iconSize="20" />
        <span slot="describe">
    ...
    <mu-list>
      ...
      <mu-list-item title="Maco Mai" :disableRipple="true">
        ...
        <mu-icon value="chat_buttle" slot="right" />
      </mu-list-item>
      <mu-divider inset/>
